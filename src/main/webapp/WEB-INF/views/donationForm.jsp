...
<%--                <form:checkboxes itemLabel="name" class="form-group--checkbox"--%>
<%--                                       itemValue="id" path="category" items="${categories}"/>--%>
                                    ...
                                    <c:forEach  items="${categories}" var="cat">
                                        ...
                                        <div class="form-group form-group--checkbox">
                                            ...
                                            <label>
                                                <input id="cat" type="checkbox" name="categories" value="${cat.name}"/>
                    ...
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span id="oddane" class="summary--text"
                            ...
                            <li>
                                ...
                                <span id="showInsti" class="summary--text"
